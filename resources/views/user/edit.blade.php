            ...
            <div class="card">
                <div class="card-header">
                    {{ __('Edit user') }}
                                    ...
                                    <a class="nav-link" href="{{ route('users.index') }}">{{ __('back') }}</a>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.update',$user) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="number" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number"  value="{{ $user->phone_number }}" >
...
<!-- 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('gender') is-invalid @enderror" name="gender" value="{{ $user->gender }}"  >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="birth_date" type="text" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ $user->birth_date }}"  >
